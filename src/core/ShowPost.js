...
const ShowPost=()=>{
	...
	return (
			...
			<div className="container" style={{position: "absolute",
				...
				<button onClick={handleclick} style={{"float":"right"}}  className="btn btn-success">Comment</button>
				</div>
			</div>
			<div >
					...
					{comment.map((home ,i)=> <div   className="comment-section-user">
						...
						{home.nameuser===nameuser ? showEditButton(home._id,home.commentpost) : ''}
                     	...
                     	<p>{home.commentpost}</p>
							...
							<button  onClick={() => showrepliesclick(home._id)} className="btn btn-success">View Replies</button>
